/**
 * This is part of GMod by Garry Newman.
 * File has been added for compatibility with
 * Sandbox weapons, for example CS:S Realistic or
 * BF3 SWEPs.
 *
 * Author: Garry Newman/The GMod Team.
 */
